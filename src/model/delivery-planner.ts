...
When a bounded finish line is supplied, plan only work necessary to its unmet criteria. Preserve exclusions, map human prerequisites to the affected capability, and do not invent further work after the agreed outcome is covered. User acceptance is not independent verification or client signoff.
